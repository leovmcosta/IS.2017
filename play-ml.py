#!usr/bin/env python
"""
A command line program for playing a single game between two ml-bots.
...
def call_engine(options):
    ...
    # Create player 1
    player1 = util.load_player_ml(options.player1)

    # Create player 2
    player2 = util.load_player_ml(options.player2)
